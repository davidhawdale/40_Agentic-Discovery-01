...
> **Directive workflow** — triggered by user request. See `01-directives/05-generate-mvp-document.md` for goal, inputs, and acceptance criteria.
...
- Required inputs:
  - `05-outputs/04-generate-vc-pitch/vc-pitch-one-pager.md`
...
- Output:
  - `04-process/05-generate-mvp-document/manifest.json`
- PASS when:
...
- Run simultaneously:
  1. `market-reviewer` → `04-process/05-generate-mvp-document/market-review.md`
  2. `ux-architect` → `04-process/05-generate-mvp-document/target-user.md`
  3. `staff-engineer` → `04-process/05-generate-mvp-document/risks-constraints.md`
- Input for all three:
  - `04-process/05-generate-mvp-document/manifest.json`
- PASS when:
...
- Run:
  1. `business-opportunity` → `04-process/05-generate-mvp-document/business-opportunity.md`
- Input:
  - `04-process/05-generate-mvp-document/manifest.json`
...
- Run:
  1. `mvp-writer` → `05-outputs/05-generate-mvp-document/mvp-brief.md`
- Input:
  - `04-process/05-generate-mvp-document/manifest.json`
...
- Run:
  1. `python3 02-workflows/generate-mvp-document/verify-mvp-output.py --file 05-outputs/05-generate-mvp-document/mvp-brief.md --max-words 2500`
- PASS when:
...
- Section files stay in `04-process/05-generate-mvp-document/`.
- Final deliverable is written directly to `05-outputs/05-generate-mvp-document/mvp-brief.md`.
...
- [ ] Final deliverable exists at `05-outputs/05-generate-mvp-document/mvp-brief.md`
